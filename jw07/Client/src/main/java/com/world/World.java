...
public class World implements Serializable{
    ...
    private List<List<Creature>> paths;
    private static final int PLAYNUM = 3;
    ...
    public World(Tile[][] tiles) {
        ...
        //this.paths = new ArrayList<List<Creature>>();
    }
    ...
    public void addlocation(Creature creature, int x, int y, int index){
        creature.setX(x);
        creature.setY(y);
        this.creatures.add(creature);
        this.paths.get(index).add(creature);
    }
    ...
    public void addpath(List<Creature> target){
    ...
    public List<List<Creature>> getPaths() {
        return this.paths;
    }
    ...
    public void go(Creature player, int x, int y){
        if (x < 0 || x >= width || y < 0 || y >= height){
            player.setstate(-1);
        }
    ...
    public void belongger(Creature player, int x, int y){
